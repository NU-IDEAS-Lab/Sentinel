...
def get_objects_with_name_and_prop(name, prop, metadata):
    ...
    for obj in metadata["objects"]:
        ...
        # Special case for StoveBurner since its toggleable property is not set correctly in Ai2Thor
        elif prop == "toggleable" and name == "StoveBurner" and "StoveBurner" in obj["objectId"]:
            res.append(obj)
    return res
