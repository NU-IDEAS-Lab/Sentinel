...
class EvalLLMAstar(EvalLLM):
    ...
    def _execute_goto(self, env, action: Dict, smooth_nav: bool):
        ...
        if reachable.metadata is None or reachable.metadata["lastActionSuccess"] is False:
            return False, env.last_event, 'GetReachablePositions failed'
        ...
        if not poses:
            return False, env.last_event, 'No interactable poses returned for target object'
